...
namespace FX.MainForms
{
    ...
    */
    ...
    {
        //电商ID
        public static string EBusinessID = "1589422";  // 1381675
        //电商加密私钥，快递鸟提供，注意保管，不要泄漏
        public static string AppKey = "909b6d59-5ffd-4908-8d10-e4fb28f36768"; //  b82eaec4-4857-468d-9225-74c660d9aa96
        //请求url
        //正式环境地址
        public static string ReqURL = "http://api.kdniao.com/api/EOrderService";

        //测试环境地址
        //public static string ReqURL = "http://testapi.kdniao.cc:8081/api/EOrderService";
